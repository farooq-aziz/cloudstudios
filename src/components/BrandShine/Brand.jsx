...
const Brand = ({ content }) => {
    ...
    const { title, subtitle, desc, branImage, isBranImage, btnTxt, css, positionCss, btnTitle } = content
    return (
        <>
                    ...
                    <div className="grid grid-cols-12">
                        {isBranImage ?
                            ...
                            <div className="col-span-12 lg:col-span-6">
                                ...
                                <div className="btn mt-6">
                                    <Link class="text-[12px] md:text-[15px] font-semibold leading-[25px] text-white bg-black rounded-[5px] w-full md:w-[410px] h-[44px] poppins flex items-center justify-center" href="javascript:;">{btnTitle ? btnTitle : "Let's Begin Your Animated Journey Together!" }</Link>
                                </div>
                            </div>}
